...
class TxFetcher:
    ...
    def get_url(cls, testnet=False):
        if testnet:
            ...
            #https://bitnodes.io 확인d
            return 'http://1.215.199.250:8333'
        else:
...
class Tx:
    ...
    def parse(cls, s, testnet=False):
        ...
        return __class__(version, tx_ins, tx_outs, locktime, testnet)
...
class TxIn:
    ...
    def parse(cls, s):
        ...
        return __class__(prev_tx, prev_index, script, seq)
...
class TxOut:
    ...
    def parse(cls, s):
        ...
        return __class__(amount, script_pubkey)
