...
class ECCTest(TestCase):
    def get_point(self, x, y, a, b, prime):
        _x = FieldElement(x, prime)
        _y = FieldElement(y, prime)
    ...
    def test_add(self):
        ...
        for x1, y1, x2, y2, x3, y3 in additions:
            expected = self.get_point(x3, y3, a, b, prime)
            result = self.get_point(x1, y1, a, b, prime) + self.get_point(x2, y2, a, b, prime)
